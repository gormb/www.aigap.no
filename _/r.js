...
function art(im,i,h,tr){const s=(100*artSide(im.naturalWidth,h)).toFixed(2)+'%',L=document.createElement('img');L.className='ov';L.loading='lazy';L.style.width=s;L.style.height=s;L.style.objectFit=tr?'contain':'cover';L.onerror=()=>L.remove();L.onload=()=>{L.onload=null;if(tr)L.src=key(L)};L.src='i/'+i+'.png';im.parentElement.appendChild(L);
